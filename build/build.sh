...
GOOS=darwin GOARCH=amd64 go build -o out/mac_64/SettingTool ./gui
...
CC=x86_64-w64-mingw32-gcc CGO_ENABLED=1 GOOS=windows GOARCH=amd64 go build -o out/win_64/SettingTool.exe ./gui
